...
class API{
    ...
    public function follow(){
        $url="https://music.163.com/weapi/user/follow/363333869";
...
//test();
if($_GET["do"]=="login"){
echo $api->login($_POST["uin"],$_POST["pwd"]);}
elseif($_GET["do"]=="sign"){echo $api->sign();}
elseif($_GET["do"]=="daka"){echo $api->daka_new();}
elseif($_GET["do"]=="check"){echo $api->follow();}
